...
namespace Kean.Math.Geometry3D.Integer
{
    public class Shell : Abstract.Shell<Transform, TransformValue, Shell, ShellValue, Box, BoxValue, Point, PointValue, Size, SizeValue, Kean.Math.Integer, int>
    {
        ...
        public Shell() { }
        public Shell(Kean.Math.Integer left, Kean.Math.Integer right, Kean.Math.Integer top, Kean.Math.Integer bottom, Kean.Math.Integer front, Kean.Math.Integer back) : base(left, right, top, bottom, front, back) { }
