...
{
    public class InfinityPoint : Abstract.InfinityPoint<Transform, TransformValue, InfinityPoint, PointValue, Size, SizeValue, Kean.Math.Double, double>
    {
        public override PointValue Value { get { return (PointValue)this; } }
        public InfinityPoint() { }
        public InfinityPoint(Kean.Math.Double x, Kean.Math.Double y, Kean.Math.Double z) : base(x, y, z) { }
        #region Casts
