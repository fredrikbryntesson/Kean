...
namespace Kean.Math.Geometry2D.Single
{
		...
		Abstract.ISize<float>, Abstract.IVector<float>
	{
        ...
        {
            return new SizeValue(Kean.Math.Single.Maximum(this.Width, other.Width), Kean.Math.Single.Maximum(this.Height, other.Height));
        }
        public SizeValue Minimum(SizeValue other)
        {
            return new SizeValue(Kean.Math.Single.Minimum(this.Width, other.Width), Kean.Math.Single.Minimum(this.Height, other.Height));
        }
        #endregion
