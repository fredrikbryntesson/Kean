...
namespace Kean.Math.Geometry2D.Abstract
{
    public abstract class Box<TransformType, TransformValue, BoxType, BoxValue, PointType, PointValue, SizeType, SizeValue, R, V> :
        ...
        where PointType : Point<TransformType, TransformValue, PointType, PointValue, R, V>, IPoint<V>, new()
        ...
        where V : struct
    {
        ...
        public static BoxType operator +(Box<TransformType, TransformValue, BoxType, BoxValue, PointType, PointValue, SizeType, SizeValue, R, V> box, PointType point)
        {
        ...
        public static BoxType operator +(Box<TransformType, TransformValue, BoxType, BoxValue, PointType, PointValue, SizeType, SizeValue, R, V> box, SizeType size)
        {
