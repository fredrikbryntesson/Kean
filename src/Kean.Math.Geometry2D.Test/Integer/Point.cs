...
namespace Kean.Math.Geometry2D.Test.Integer
{
    [TestFixture]
    public class Point :
        Kean.Math.Geometry2D.Test.Abstract.Point< Kean.Math.Geometry2D.Integer.Transform,  Kean.Math.Geometry2D.Integer.TransformValue, Kean.Math.Geometry2D.Integer.Point, Kean.Math.Geometry2D.Integer.PointValue,  Kean.Math.Geometry2D.Integer.Size,  Kean.Math.Geometry2D.Integer.SizeValue, 
