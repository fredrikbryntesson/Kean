...
namespace Kean.Math.Geometry2D.Test.Double
{
    [TestFixture]
    public class Point :
        Kean.Math.Geometry2D.Test.Abstract.Point< Target.Double.Transform,  Target.Double.TransformValue, Target.Double.Point, Target.Double.PointValue,  Target.Double.Size,  Target.Double.SizeValue, 
