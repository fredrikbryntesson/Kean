...
namespace Kean.Math.Geometry2D.Single
{
		...
		IEquatable<ShellValue>
    {
		...
		public ShellValue(float value) : this(value, value) { }
		public ShellValue(float x, float y) : this(x, x, y, y) { }
		...
		public BoxValue Increase(Abstract.IBox<PointValue, SizeValue, float> box)
		{
			return new BoxValue(box.LeftTop.X - this.Left, box.LeftTop.Y - this.Top, box.Size.Width + this.Left + this.Right, box.Size.Height + this.Top + this.Bottom);
		}
		#endregion
