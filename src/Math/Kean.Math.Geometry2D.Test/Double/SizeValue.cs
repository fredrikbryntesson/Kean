...
namespace Kean.Math.Geometry2D.Test.Double
{
        ...
        Kean.Test.Fixture<SizeValue>
    {
        ...
        Target.Double.SizeValue vector0 = new Target.Double.SizeValue(22.221f, -3.1f);
        Target.Double.SizeValue vector1 = new Target.Double.SizeValue(12.221f, 13.1f);
        Target.Double.SizeValue vector2 = new Target.Double.SizeValue(34.442f, 10.0f);
        Target.Double.SizeValue vector3 = new Target.Double.SizeValue(10, 20);
        ...
        public void Polar5()
        {
            Target.Double.SizeValue point = new Target.Double.SizeValue(33, -7);
