...
namespace Kean.Math.Geometry2D.Test.Double
{
        ...
        Kean.Test.Fixture<TransformValue>
    {
        ...
        {
            this.transform0 = new Target.Double.TransformValue(1, 4, 2, 5, 3, 6);
            this.transform1 = new Target.Double.TransformValue(7, 4, 2, 5, 7, 6);
            this.transform2 = new Target.Double.TransformValue(15, 48, 12, 33, 22, 64);
            this.transform3 = new Target.Double.TransformValue(-5 / 3.0f, 4 / 3.0f, 2 / 3.0f, -1 / 3.0f, 3 / 3.0f, -6 / 3.0f);
        ...
        public void Scale()
        {
            ...
            transform = transform.Scale(1 / scale, 1 / scale);
