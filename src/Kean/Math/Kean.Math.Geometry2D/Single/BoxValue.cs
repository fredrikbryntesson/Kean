...
namespace Kean.Math.Geometry2D.Single
{
		...
		IEquatable<BoxValue>
    {
		...
		public PointValue RightBottom { get { return this.LeftTop + (Abstract.IVector<float>)this.Size; } }
		#endregion
		public PointValue Center { get { return this.LeftTop + (Abstract.IVector<float>)(this.Size / 2); } }
		...
		public BoxValue Pad(float left, float right, float top, float bottom)
		{
		...
		public BoxValue Ceiling()
		{
			...
			return new BoxValue(leftTop, (SizeValue)(this.RightBottom.Ceiling() - (Abstract.IVector<float>)leftTop));
		}
		...
		public static BoxValue operator +(BoxValue left, BoxValue right)
		{
			...
			if (left.Empty)
				...
				result = new BoxValue(Kean.Math.Single.Minimum(left.Left, right.Left), Kean.Math.Single.Minimum(left.Top, right.Top), Kean.Math.Single.Maximum(left.Right, right.Right) - Kean.Math.Single.Minimum(left.Left, right.Left), Kean.Math.Single.Maximum(left.Bottom, right.Bottom) - Kean.Math.Single.Minimum(left.Top, right.Top));
			return result;
		}
		public static BoxValue operator -(BoxValue left, BoxValue right)
		{
		...
		{
			return new BoxValue(left.LeftTop + (Abstract.IVector<float>)right, left.Size);
		}
		public static BoxValue operator -(BoxValue left, PointValue right)
		{
