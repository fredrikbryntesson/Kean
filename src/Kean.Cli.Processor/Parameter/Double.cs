...
namespace Kean.Cli.Processor.Parameter
{
		...
		Abstract
	{
		...
		{
			return ((double)value).ToString(System.Globalization.CultureInfo.InvariantCulture.NumberFormat);
		}
		public override object FromString(string value)
		{
			double result = 0;
			double.TryParse(value, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture.NumberFormat, out result);
			return result;
		}
