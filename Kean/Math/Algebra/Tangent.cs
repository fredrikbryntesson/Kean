...
namespace Kean.Math.Algebra
{
	...
	Function
	{
		protected override string Symbol { get { return "tan"; } }
        public Tangent(Expression argument) :
			base(argument)
		{
		}
		public override float Evaluate(params KeyValue<string, float>[] variables)
		{
			return Single.Tangens(this.Argument.Evaluate(variables));
		}
		...
		{
			return new Tangent(this.Argument.Simplify());
		}
	}
}
