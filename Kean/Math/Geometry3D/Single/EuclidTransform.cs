...
namespace Kean.Math.Geometry3D.Single
{
    ...
    {
        public Geometry3D.Single.Rotation Rotation { get; private set; }
        public Geometry3D.Single.Size Translation { get; private set; }

        public EuclidTransform Inverse { get { return new EuclidTransform(this.Rotation.Inverse, -1*this.Translation); } }

        public EuclidTransform(Geometry3D.Single.Rotation rotation) :
            this(rotation, new Geometry3D.Single.Size(0, 0, 0))
        { }
        public EuclidTransform(Geometry3D.Single.Size translation) :
            this(new Geometry3D.Single.Rotation(0,0,0), translation)
        { }
        public EuclidTransform(Geometry3D.Single.Rotation rotation, Geometry3D.Single.Size translation) : 
            this()
        {
        ...
        public EuclidTransform Translate(Geometry3D.Single.Size translation)
        {
        ...
        #endregion
        #region Casts
        public static implicit operator Geometry3D.Single.Transform(EuclidTransform value)
        {
            return  Geometry3D.Single.Transform.CreateRotationX(value.Rotation.RotationX).RotateY(value.Rotation.RotationY).RotateZ(value.Rotation.RotationZ).Translate(value.Translation);
        }
