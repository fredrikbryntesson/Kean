...
namespace Kean.Math.Geometry3D.Double
{
	...
	IEquatable<Box>
    {
		...
		public double Right { get { return this.LeftTopFront.X + this.Size.Width; } }
		public double Top { get { return this.LeftTopFront.Y; } }
		public double Bottom { get { return this.LeftTopFront.Y + this.Size.Height; } }
		public double Front { get { return this.LeftTopFront.Z; } }
		public double Back { get { return this.LeftTopFront.Z + this.Size.Depth; } }
		#endregion
        ...
        public Box(double left, double top, double front, double width, double height, double depth) : 
			this(new Point(left, top, front), new Size(width, height, depth)) 
		{ }
        public Box(Size size) :
			this(new Geometry3D.Double.Point(), size) 
		{ }
        
        public  Box Pad(double left, double right, double top, double bottom, double front, double back)
        {
		...
		public static Box operator +(Box left, Box right)
		{
			...
			if (left.Empty)
				...
				result = new Box(Kean.Math.Double.Minimum(left.Left, right.Left), Kean.Math.Double.Minimum(left.Top, right.Top), Kean.Math.Double.Minimum(left.Front, right.Front), Kean.Math.Double.Maximum(left.Right, right.Right) - Kean.Math.Double.Minimum(left.Left, right.Left), Kean.Math.Double.Maximum(left.Bottom, right.Bottom) - Kean.Math.Double.Minimum(left.Top, right.Top), Kean.Math.Double.Maximum(left.Back, right.Back) - Kean.Math.Double.Minimum(left.Front, right.Front));
			return result;
		}
		public static Box operator -(Box left, Box right)
		{
			...
			if (!left.Empty && !right.Empty)
			{
				 ...
				 double u = Kean.Math.Double.Maximum(left.Front, right.Front);
				 double v = Kean.Math.Double.Minimum(left.Back, right.Back);
				if (l < r && t < b && u < v)
				{
		...
		public static Box Bounds(double left, double right, double top, double bottom, double front, double back)
		{
		...
		public static Box Bounds(params Point[] points)
		{
			...
			if (points.Length > 0)
			{
				...
				double zMinimum = xMinimum;
				double zMaximum = xMinimum;
