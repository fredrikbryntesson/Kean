...
namespace Kean.Math.Geometry3D.Double
{
	...
	*/
		...
		IEquatable<Transform>
	{
		...
		public static explicit operator Transform(Geometry2D.Double.Transform value)
		{
			double zero = 0;
			double one = 1;
			return new Transform(value.A, value.B, zero, value.D, value.E, zero, zero, zero, zero, value.G, value.H, zero);
		}
		public static explicit operator Geometry2D.Double.Transform(Transform value)
		{
			return new Geometry2D.Double.Transform(value.A, value.B, value.D, value.E, value.J, value.K);
		}
