...
namespace Kean.Math.Geometry2D.Integer
{
		...
		IEquatable<Point>
	{
		...
		public Point Project(Geometry3D.Integer.Transform transform, int planeZ)
		{
			var transformed = transform * new Geometry3D.Integer.Point(this.X, this.Y, planeZ);
		...
		{
			return new Point(radius * Kean.Math.Integer.Cosine(azimuth), radius * Kean.Math.Integer.Sine(azimuth));
		}
		#endregion
		#region Casts
