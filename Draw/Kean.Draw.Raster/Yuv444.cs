...
namespace Kean.Draw.Raster
{
		...
		YuvPlanar
	{
		...
		public Yuv444(Geometry2D.Integer.Size size, CoordinateSystem coordinateSystem) :
			this(new Buffer.Vector<byte>(3 * Packed.CalculateLength(size, 1)), size, coordinateSystem) { }
		...
		public Yuv444(Buffer.Sized buffer, Geometry2D.Integer.Size size, CoordinateSystem coordinateSystem) :
