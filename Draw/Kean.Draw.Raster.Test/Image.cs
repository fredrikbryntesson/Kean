...
namespace Kean.Draw.Raster.Test
{
		...
		where T : Image<T>, new()
	{
		...
		public void Text()
		{
			using (Draw.Image image = this.CreateImage(new Geometry2D.Integer.Size(128, 256)))
			{
				image.Canvas.Draw(Colors.Blue, new Stroke(Colors.Red, 1), new Text() { Markup = "Kean Toolkit", Font = new Font("Verdana", 12, FontWeight.Normal, FontSlant.Normal) }, new Geometry2D.Single.Point(10, 20));
		...
		public void TextFill()
		{
			using (Draw.Image image = this.CreateImage(new Geometry2D.Integer.Size(128, 256)))
			{
				image.Canvas.Draw(Colors.Blue, new Text() { Markup = "Kean Toolkit", Font = new Font("Verdana", 12, FontWeight.Normal, FontSlant.Normal) }, new Geometry2D.Single.Point(10, 20));
		...
		public void TextStroke()
		{
			using (Draw.Image image = this.CreateImage(new Geometry2D.Integer.Size(128, 256)))
			{
				image.Canvas.Draw(new Stroke(Colors.Red, 1), new Text() { Markup = "Kean Toolkit", Font = new Font("Verdana", 12, FontWeight.Normal, FontSlant.Normal) }, new Geometry2D.Single.Point(10, 20));
