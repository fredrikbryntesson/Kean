...
namespace Kean.Math.Geometry3D.Double
{
    public struct Shell 
    {
		...
		//public Shell(double x, double y, double z) : this(x, x, y, y, z, z) { }

        public Shell(double left, double right, double top, double bottom, double front, double back) 
			{
				this.Left = left;
				this.Right = right;
				this.Top = top;
        ...
        public Box Decrease(Size size)
		  ...
		  #endregion
		  public static Shell Create(double left, double right, double top, double bottom, double front, double back)
		  {
