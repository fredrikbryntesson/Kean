...
namespace Kean.Math.Geometry3D.Test.Double
{
        ...
        Kean.Math.Geometry3D.Test.Abstract.Point<Point, Target.Double.Transform, Target.Double.TransformValue, Target.Double.Point, Target.Double.PointValue, Target.Double.Size, Target.Double.SizeValue, Kean.Math.Double, double>
    {
        ...
        public void Sphere0()
        {
           ...
           Verify(point.Norm.Value, Is.EqualTo(0));
           Verify(point.Azimuth.Value, Is.EqualTo(0));
           Verify(point.Elevation.Value, Is.EqualTo(0));
        }
        [Test]
        public void Sphere1()
        {
            Target.Double.Point point = new Target.Double.Point(1, 0, 0);
           Verify(point.Norm.Value, Is.EqualTo(1));
           Verify(point.Azimuth.Value, Is.EqualTo(0));
           Verify(point.Elevation.Value, Is.EqualTo(Kean.Math.Double.ToRadians(90)));
        }
        [Test]
        public void Sphere2()
        {
            Target.Double.Point point = new Target.Double.Point(0, 5, 0);
           Verify(point.Norm.Value, Is.EqualTo(5));
           Verify(point.Azimuth.Value, Is.EqualTo(Kean.Math.Double.ToRadians(90)));
           Verify(point.Elevation.Value, Is.EqualTo(Kean.Math.Double.ToRadians(90)));
        }
        [Test]
        public void Sphere3()
        ...
        public void Sphere4()
        {
           ...
           Verify(point.Norm.Value, Is.EqualTo(5));
           Verify(point.Azimuth.Value, Is.EqualTo(Kean.Math.Double.ToRadians(180)));
           Verify(point.Elevation.Value, Is.EqualTo(Kean.Math.Double.ToRadians(90)));
        }
        [Test]
        public void Sphere5()
        {
           ...
           Verify(point.Norm.Value, Is.EqualTo(1));
           Verify(point.Azimuth.Value, Is.EqualTo(Kean.Math.Double.ToRadians(0)));
           Verify(point.Elevation.Value, Is.EqualTo(Kean.Math.Double.ToRadians(0)));
        }
        [Test]
        public void Sphere6()
        {
           ...
           Verify(point.Distance(point2).Value, Is.EqualTo(0).Within(this.Precision));
        }
        #endregion
        ...
        public void ValueCasts()
        {
            // integer - double
            {
               ...
               Verify(@double.Y, Is.EqualTo(20));
               Verify(@double.Z, Is.EqualTo(30));
               Verify((Target.Integer.PointValue)@double, Is.EqualTo(integer));
            }
            {
               ...
               Verify(@double.Y, Is.EqualTo(20));
               Verify(@double.Z, Is.EqualTo(30));
               Verify((Target.Single.PointValue)@double, Is.EqualTo(single));
            }
        }
        [Test]
