...
namespace Kean.Math.Geometry3D.Test.Single
{
		...
		Kean.Test.Fixture<Box>
    {
          ...
          Target.Single.Box Box0 = new Target.Single.Box(1, 2, 3, 4, 5, 6);
          Target.Single.Box Box1 = new Target.Single.Box(4, 3, 2, 1, 5, 6);
		  Target.Single.Box Box2 = new Target.Single.Box(2, 1, 4, 3, 5, 6);
		...
		public void LeftTop()
		{
			Target.Single.Point leftTop = this.Box0.LeftTopFront;
        ...
        {
            string textFromValue = new Target.Single.Box(10, 20, 30, 40, 50, 60);
            Verify(textFromValue, Is.EqualTo("10, 20, 30, 40, 50, 60"));
            Target.Single.Box @integerFromText = "10 20 30 40 50 60";
