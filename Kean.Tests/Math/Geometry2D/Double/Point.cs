...
namespace Kean.Math.Geometry2D.Test.Double
{
    ...
    {
        string prefix = "Kean.Math.Geometry2D.Test.Double.Point";
        float Precision { get { return 1e-4f; } }
        Target.Double.Point CastFromString(string value)
        {
            return (Target.Double.Point)value;
        }
        string CastToString(Target.Double.Point value)
        {
            return value;
        }
        Target.Double.Point vector0 = new Target.Double.Point((double)22.221f, (double)-3.1f);
        Target.Double.Point vector1 = new Target.Double.Point((double)12.221f, (double)13.1f);
        Target.Double.Point vector2 = new Target.Double.Point((double)34.442f, (double)10.0f);
        Target.Double.Point vector3 = new Target.Double.Point((double)10, (double)20);
        ...
        {
            Verify(this.vector0 - this.vector0, Is.EqualTo(new Target.Double.Point()));
        }
        [Test]
        ...
        {
            Verify(this.vector0.X, Is.EqualTo((double)(22.221)).Within(this.Precision), this.prefix + "GetValues.0");
            Verify(this.vector0.Y, Is.EqualTo((double)(-3.1)).Within(this.Precision), this.prefix + "GetValues.1");
        }
        [Test]
        public void Swap()
        {
            Target.Double.Point result = this.vector0.Swap();
        ...
        public void Polar5()
        {
            Target.Double.Point point = new Target.Double.Point(-3, 0);
        ...
        public void Casts()
        {
            // integer - double
            {
                ...
                Verify((Target.Integer.Point)@double, Is.EqualTo(integer));
            }
            // single - double
            {
                ...
                Verify(@double.X, Is.EqualTo(10));
                Verify(@double.Y, Is.EqualTo(20));
                Verify((Target.Single.Point)@double, Is.EqualTo(single));
            }
        }
		[Test]
        public void StringCasts()
        {
            string textFromValue = new Target.Double.Point(10, 20);
            Verify(textFromValue, Is.EqualTo("10, 20"));
            Target.Double.Point @integerFromText = (Target.Double.Point)"10, 20";
