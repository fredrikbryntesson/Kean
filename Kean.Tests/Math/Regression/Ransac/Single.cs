...
namespace Kean.Math.Regression.Test.Ransac
{
		...
		Kean.Test.Fixture<Single>
	{
		...
		public void RobustPolynomialRegression()
		{
			...
			Target.Model<float, float, Kean.Math.Matrix.Single> model = new Kean.Tests.Math.Regression.Ransac.Model.RobustPolynomialRegression();
		...
		public void ScaleRotationTranslationRegression()
		{
			...
			Target.Model<Geometry2D.Single.Point, Geometry2D.Single.Point, Kean.Math.Matrix.Single> model = new Kean.Tests.Math.Regression.Ransac.Model.ScaleRotationTranslationRegression();
		...
		{
			Target.Model<Geometry2D.Single.Point, Geometry2D.Single.Point, Geometry2D.Single.Point> model = new Kean.Tests.Math.Regression.Ransac.Model.TranslationRegression();
